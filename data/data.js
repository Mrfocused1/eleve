...
export const PRODUCTS = [
  {
    ...
    description: "Signature shaping faja — final release stock from the FigureBySLA collection. A new Élevé-branded release is coming soon.",
    image: "assets/product-shape-me-faja.png",
    colombian: true,
    finalRelease: true,
    stock: [
      { size: "S",    qty: 1 },
