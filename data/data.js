...
/* Retail products — curated aftercare & tools lineup.
   Placeholder catalogue — swap with real SKUs/prices when available. */
export const PRODUCTS = [
  {
    ...
    image: "assets/product-body-oil.svg",
  },
  {
  ...
  {
    id: "lymphatic-brush",
    name: "Dry Brush — Lymphatic",
    price: 24,
    category: "Tools",
    tagline: "Stiff natural bristle, cherry wood.",
    description: "Stimulate circulation before showering. Part of Malika's daily reset ritual.",
    image: "assets/product-brush.svg",
  },
  {
    id: "gua-sha-stone",
    name: "Gua Sha — Hand Cut Rose Quartz",
    price: 38,
    category: "Tools",
    tagline: "Facial drainage + definition.",
    description: "Cooling stone for daily facial lymphatic work. Includes usage map.",
    image: "assets/product-gua-sha.svg",
  },
  {
    id: "compression-band",
    name: "Post-Op Abdominal Band",
    price: 58,
    category: "Post-Op",
    tagline: "Medical-grade compression.",
    description: "Breathable cotton band for the first 8 weeks post-procedure. Sizes XS–XL.",
    image: "assets/product-band.svg",
    variants: [{ id: "xs", label: "XS" }, { id: "s", label: "S" }, { id: "m", label: "M" }, { id: "l", label: "L" }, { id: "xl", label: "XL" }],
  },
  {
    id: "post-op-vest",
    ...
    image: "assets/product-vest.svg",
    variants: [{ id: "xs", label: "XS" }, { id: "s", label: "S" }, { id: "m", label: "M" }, { id: "l", label: "L" }, { id: "xl", label: "XL" }],
  },
  {
    id: "foam-roller",
    name: "Lymphatic Foam Roller",
    price: 42,
    category: "Tools",
    tagline: "Travel size. Eva foam.",
    description: "At-home mobility and drainage. 45cm length.",
    image: "assets/product-roller.svg",
  },
  {
    id: "wellness-tea",
    name: "Élevé Reset Tea",
    price: 18,
    category: "Wellness",
    tagline: "Gut-friendly infusion.",
    description: "Nettle, dandelion, ginger. Loose-leaf 60g tin. 30 cups.",
    image: "assets/product-tea.svg",
  },
  {
    id: "gift-100",
    ...
    price: 100,
    category: "Gifting",
    tagline: "Redeemable against any treatment.",
    description: "Delivered by email. Valid 12 months.",
